...
class ApiController extends Controller
{
    ...
    const CODE_WRONG_ARGS = 'GEN-FUBARGS';//代码错误的参数
    const CODE_NOT_FOUND = 'GEN-LIKETHEWIND';//代码错误没有找到
    const CODE_INTERNAL_ERROR = 'GEN-AAAGGH';//代码内部错误
    const CODE_UNAUTHORIZED = 'GEN-MAYBGTFO';//代码未授权
    const CODE_FORBIDDEN = 'GEN-GTFO';//非法操作
    const CODE_INVALID_MIME_TYPE = 'GEN-UMWUT';//无效操作
    ...
    public function __construct()
    {
        ...
        /*$this->fractal->parseIncludes('tags,category');
